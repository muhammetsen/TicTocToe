var x = "images/cross.jpg";

var o = "images/zero.jpg";
...
var ts = 0;
function help() {
alert("Welcome to Classic Tic-Tac-Toe!  You will play as cross and computer will play as zero. Select the tile by clicking them. The first player to get three tiles in a row wins.  Good Luck!!")
}
function logicOne() {
...
function taken() {
alert("This tile is already filled. Please select another tile.")
pause=1;
}
function myChoice() {
temp="";
...
function ended() {
alert("Game finished. To play again click Play Again Button.")
}
function process() {
logicOne();
if (all==1){ alert("Congratulations!! You WON"); wn++; }
if (all==2){ alert("Oops!!  I win!"); ls++; }
if (all==3){ alert("Game tied."); ts++; }
if (all!=0) {
...
function playAgain() {
if (all==0) {
if(confirm("Do you want to restart the game ?")) reset();
}
if (all>0) reset();
}
function reset() {
